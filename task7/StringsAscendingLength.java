package tests.task7;
//Ввести n строк с консоли. Упорядочить и вывести строки в порядке возрастания значения их длинны
import java.util.InputMismatchException;
import java.util.Scanner;

public class StringsAscendingLength {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < n; i++) {
            ...
            for (int j = strings[i].length(); j < maxLength + 2; j++) {
                System.out.print(".");
            }
